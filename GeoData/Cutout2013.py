...
minx, miny, maxx, maxy = eez_shape.total_bounds
buffer = 0.25
cutout = atlite.Cutout("Japan.nc")
cutout = atlite.Cutout(
   path= '...\GeoData\JPera.nc',
   module="era5",
...
Offwind_2013=wind.to_pandas()
Offwind_2013 = Offwind_2013.resample('3H').sum()
Offwind_2013.plot()
